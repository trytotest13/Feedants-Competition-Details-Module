...
- [x] P1.4 Backend scaffold (TS strict)
- [x] P1.5 Mobile scaffold (Expo SDK 54)
- [x] P2.1 Models + indexes per schema.md
- [x] P2.2 Config, DB fallback, security middleware
- [x] P2.3 Auth (register/login/me, referral hook)
